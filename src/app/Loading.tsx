  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[999] bg-gradient-to-br from-black via-blue-900 to-black animate-bg-motion">
      ...
      <div className="relative flex flex-col items-center space-y-6 z-10">
        ...
        {/* Welcome Message */}
        <p className="text-lg text-center text-blue-300 font-semibold max-w-md px-4 animate-fade-in">
          🛍️ Welcome to Bandage – Your One-Stop Fashion Destination! 🛍️ <br />
          &quot;Discover the latest trends, shop exclusive collections, and enjoy a seamless shopping experience!&quot;
        </p>
