...
import AllCommentData from "@/app/components/AllCommentData";
  ...
  return (
    <div className="pt-20 w-full">
      <div className="max-w-screen-md mx-auto py-20 px-10">
        ...
        <BlogAnimation>
          <p className="text-2xl leading-relaxed preformatted-content py-10">{post.content}</p>
        </BlogAnimation>

        <BlogAnimation>
          <div className={richTextStyles}>
            <AddComment blogId={post?._id} />
            <AllCommentData comments={post?.comments || []} id={post?._id} commentsOrder="desc" />
          </div>
        </BlogAnimation>
      </div>
    </div>
